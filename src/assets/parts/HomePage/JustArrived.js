        ...
        <div class="overflow-hidden z-10">
          <div class="flex -mx-4 flex-row relative">
            ...
            <div class="px-4 relative card group">
              ...
              >
                <div class="absolute opacity-0 group-hover:opacity-60 transition duration-200 flex items-center justify-center w-full h-full bg-black bg-opacity-30">
            ...
            <div class="px-4 relative card group">
              <div
                ...
                style={{ width: 287, height: 386 }}
              >
                <div class="absolute opacity-0 group-hover:opacity-60 transition duration-200 flex items-center justify-center w-full h-full bg-black bg-opacity-35">
                  <div class="bg-white text-black rounded-full w-16 h-16 flex items-center justify-center">
                    <svg
                      class="fill-current"
                      width="43"
